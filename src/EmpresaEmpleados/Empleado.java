...
public abstract class Empleado {
    ...
    public abstract boolean sueldoPlus(); //Con este metodo abstracto estamos indicando que todas las clases deben implementar este metodo
  
    @Override
    public String toString() {
        return "Nombre=" + nombre + ", edad=" + edad + ", sueldoBase=" + sueldoBase;
    }
